      ...
      >
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="bg-button hover:bg-button-hover active:bg-button-pressed rounded-lg px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors"
          >
            {state.confirmText}
          </button>
        </div>
