    ...
    <div className="flex flex-col">
      <div className="mt-32 mb-72 flex flex-col items-center justify-center">
        ...
        <div className="mx-auto mt-24 grid h-72 w-3xl grid-cols-5 place-items-center">
          ...
          <SportsTypeBtn type={SportsType.PILATES} img={Pilates} isSelected={selectedSportsType} onClick={()=>setSelectedSportsType(SportsType.PILATES)}/>
          <SportsTypeBtn type={SportsType.GOLF} img={Golf} isSelected={selectedSportsType} onClick={()=>setSelectedSportsType(SportsType.GOLF)}/>
